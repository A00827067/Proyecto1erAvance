...
b) ¿Quiénes son los usuarios, clientes o beneficiarios de este modelo?  
 ...
 f) ¿Qué estándares están implicados en este modelo y cómo se usan?  
  ...
  Google. (n.d.). Google Cloud IoT: servicios de Internet de las cosas totalmente gestionados. Google Cloud IoT. Recuperado Septiembre 17, 2020, from https://cloud.google.com/solutions/iot?hl=es
